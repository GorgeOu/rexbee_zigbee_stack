...
typedef enum {
  ...
  EMBER_ZCL_STATUS_SPECIAL_HANDING				= 0xFE, //use for disable default resp
} EmberAfStatus;
...
typedef enum _zcl_ias_zone_type_enum
{
	ZCL_IAS_ZONE_TYPE_STANDARD_CIE              = 0x0000,
	ZCL_IAS_ZONE_TYPE_MOTION_SENSOR             = 0x000D,  //pir sensor
	ZCL_IAS_ZONE_TYPE_CONTACT_SWITCH            = 0x0015,  //door sensor
	ZCL_IAS_ZONE_TYPE_FIRE_SENSOR               = 0x0028,  //smoke sensor
	ZCL_IAS_ZONE_TYPE_WATER_SENSOR              = 0x002A,
	ZCL_IAS_ZONE_TYPE_CARBON_MONOXIDE_SENSOR    = 0x002B,  //CO sensor, gas sensor
	ZCL_IAS_ZONE_TYPE_PERSONAL_EMERGENCY_DEVICE = 0x002C,
	ZCL_IAS_ZONE_TYPE_VIBRATION_MOVEMENT_SENSOR = 0x002D,
	ZCL_IAS_ZONE_TYPE_REMOTE_CONTROL            = 0x010F,
	ZCL_IAS_ZONE_TYPE_KEY_FOB                   = 0x0115,
	ZCL_IAS_ZONE_TYPE_KEYPAD                    = 0x021D,
	ZCL_IAS_ZONE_TYPE_STANDARD_WARNING_DEVICE   = 0x0225,
	ZCL_IAS_ZONE_TYPE_GLASS_BREAK_SENSOR        = 0x0226,
	ZCL_IAS_ZONE_TYPE_GAS_SENSOR    			= 0x0227,  //gas sensor
	ZCL_IAS_ZONE_TYPE_SECURITY_REPEATER         = 0x0229,
	ZCL_IAS_ZONE_TYPE_INVALID_ZONE_TYPE         = 0xFFFF,
} zcl_ias_zone_type_enum_t;

typedef enum _zcl_color_control_cluster_color_mode_enum
{
	ZCL_COLOR_MODE_CURRENT_HUE_AND_CURRENT_SATURATION 			= 0x00,
	ZCL_COLOR_MODE_CURRENT_X_AND_CURRENT_Y            			= 0x01,
	ZCL_COLOR_MODE_COLOR_TEMPERATURE                  			= 0x02,
	ZCL_COLOR_MODE_ENHANCED_CURRENT_HUE_AND_CURRENT_SATURATION 	= 0x03,
	ZCL_COLOR_MODE_USE_ATTRIBUTE_TABLE_DEFAULT					= 0xff,
} zcl_color_mode_enum_t;

typedef enum _app_trigger_source_enum
{
	APP_TRIGGER_SOURCE_ZCL_COMMAND      = 0, //Unicast command(EP != 0xff)
	APP_TRIGGER_SOURCE_ZCL_SCENE 	    = 1, //Scene
	APP_TRIGGER_SOURCE_LOCAL		    = 2, //Local write attribute
	APP_TRIGGER_SOURCE_GROUP	 	    = 3, //Group(Multicast) command
	APP_TRIGGER_SOURCE_BROADCAST	    = 4, //Broadcast command
	APP_TRIGGER_SOURCE_All_EP		    = 5, //Unicast command(EP == 0xff), auto split
	APP_TRIGGER_SOURCE_ZCL_AUTO         = 6,
	APP_TRIGGER_SOURCE_BUTTON		    = 0x11,
	APP_TRIGGER_SOURCE_UART		        = 0x12,
	APP_TRIGGER_SOURCE_BLE_GATT		    = 0x13,

	APP_TRIGGER_SOURCE_MQTT		    	= 0x14,
	APP_TRIGGER_SOURCE_HTTP		        = 0x15,
    APP_TRIGGER_SOURCE_WS               = 0x16,
	APP_TRIGGER_SOURCE_BLE_MESH_COMMAND	= 0x20,
	APP_TRIGGER_SOURCE_BLE_MESH_SCENE	= 0x21,
	APP_TRIGGER_SOURCE_BLE_MESH_GROUP	= 0x22,
	APP_TRIGGER_SOURCE_BLE_MESH_BROADCAST = 0x23,
    APP_TRIGGER_SOURCE_BLE_MESH_ALL_EP  = 0x24,
    APP_TRIGGER_SOURCE_BLE_MESH_AUTO    = 0x25,
} app_trigger_source_enum_t;

typedef enum _app_write_attribute_trigger_type_enum
{
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_ZCL_COMMAND = 0, //Unicast command(EP != 0xff)
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_ZCL_SCENE 	= 1, //Scene
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_LOCAL		= 2, //Local write attribute
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_GROUP	 	= 3, //Group(Multicast) command
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_BROADCAST	= 4, //Broadcast command
	APP_WRITE_ATTRIBUTE_TRIGGER_VIA_All_EP		= 5, //Unicast command(EP == 0xff), auto split
} app_write_attribute_trigger_type_enum_t;

typedef enum _user_window_action_enum
{
	WINDOW_ACTION_OPEN 		= 0,
	WINDOW_ACTION_CLOSE  	= 1,
	WINDOW_ACTION_STOP      = 2,
	WINDOW_ACTION_END 		= 0xff,
} user_window_action_enum_t;

typedef enum _app_concentrator_type
{
	MANY_TO_ONE_ROUTE_REQUEST_HIGH_RAM  = 1,
	MANY_TO_ONE_ROUTE_REQUEST_LOW_RAM 	= 2,
} app_concentrator_type_t;

typedef enum _app_network_start_event_action_enum
{
	APP_NETWORK_START_EVENT_REBOOT 				= 0,
	APP_NETWORK_START_EVENT_SCAN_JOINED 		= 1,
	APP_NETWORK_START_EVENT_FORM				= 2,
	APP_NETWORK_START_EVENT_FORM_BY_TOUCH_LINK 	= 2,
	APP_NETWORK_START_EVENT_FORM_BY_UART		= 3,
	APP_NETWORK_START_EVENT_FORM_BY_ZBCK		= 4,
	APP_NETWORK_START_EVENT_FAST_JOINED			= 5,
	APP_NETWORK_START_EVENT_BY_ZIGBEE_COMMAND	= 6,
} app_network_start_event_action_enum_t;

typedef enum _leave_network_reason_store
{
	LEAVE_NETWORK_REASON_UNKNOW 					= 0,
	LEAVE_NETWORK_REASON_PARENT_REQ_REJOIN			= 1,
	LEAVE_NETWORK_REASON_PARENT_REQ_LEAVE			= 2,
	LEAVE_NETWORK_REASON_POLL_LOST					= 3,
	LEAVE_NETWORK_REASON_REBOOT_SET_NO_PARENT 		= 4,
	LEAVE_NETWORK_REASON_USER_APP_CALL		  		= 5, //app_leave_network
	LEAVE_NETWORK_REASON_USER_SCAN_NETWORK_CALL 	= 6, //scan network
	LEAVE_NETWORK_REASON_NWK_CMD_PARENT_REQ_REJOIN 	= 7,
	LEAVE_NETWORK_REASON_NWK_CMD_PARENT_REQ_LEAVE  	= 8,
	LEAVE_NETWORK_REASON_NO_SIGNATURE_LEAVE		   	= 9,
	LEAVE_NETWORK_REASON_UART_LEAVE				   	= 10,
	LEAVE_NETWORK_REASON_CLI_LEAVE				   	= 11,
	LEAVE_NETWORK_REASON_VAIN_NETWORK_LEAVE_1	   	= 12,
	LEAVE_NETWORK_REASON_VAIN_NETWORK_LEAVE_2	   	= 13,
	LEAVE_NETWORK_REASON_VAIN_NETWORK_LEAVE_3	   	= 14,
	LEAVE_NETWORK_REASON_STACK_FORM_NETWORK		   	= 15,
	LEAVE_NETWORK_REASON_STACK_ZLL_FACTORY_RESET   	= 16,
	LEAVE_NETWORK_REASON_STACK_ZCL_BASIC_RESET	   	= 17,
	LEAVE_NETWORK_REASON_STACK_RWP_COMMAND_RESET	= 18,
	LEAVE_NETWORK_REASON_FAST_JOIN_SCAN_CALL		= 19,
	LEAVE_NETWORK_REASON_FAST_JOIN_REJECT		  	= 20,
	LEAVE_NETWORK_REASON_FAST_JOIN_NO_ACK		  	= 21,
} leave_network_reason_store_t;

typedef enum _app_color_plugin_stop_mode_enum
{
	APP_LEVEL_STOP_MODE,
	APP_COLOR_STOP_MODE_TEMP,
	APP_COLOR_STOP_MODE_SAT,
	APP_COLOR_STOP_MODE_HUE,
	APP_COLOR_STOP_MODE_HUE_AND_SAT,
	APP_COLOR_STOP_MODE_X,
	APP_COLOR_STOP_MODE_Y,
	APP_COLOR_STOP_MODE_XY,
	APP_COLOR_STOP_MODE_ALL_COLOR_MOVE,
} app_color_plugin_stop_mode_enum_t;
