...
#define ZCL_TUYA_RANDOM_TIMING_COMMAND_ID                                   0xF7    //随机定时下发命令(MFG=0x0000)
#define ZCL_TUYA_CYCLE_TIMING_COMMAND_ID                                    0xF8    //循环定时下发命令(MFG=0x0000)
#define ZCL_TUYA_INCHING_COMMAND_ID                                         0xFB    //点动开关下发命令(MFG=0x0000)
